...
<head>
    ...
    <link rel="stylesheet" href="css/details_seller_style.css">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="chatButton">
                                        <a href="homepage_seller.php?user_id=<?= $result['user_id']; ?>"><button class="btn chatForm" type="submit"><i class="bi bi-chevron-compact-left"></i> Back</button></a>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="chatButton">
                                        <a href="update.php?house_id=<?= $result['house_id']; ?>"><button class="btn chatForm" type="submit"><i class="bi bi-wrench"></i> Update</button></a>
                                    </div>
                                </div>
                                <div class="col-md-4 offset-md-2">
                                    <div class="chatButton">
                                        <a data-bs-toggle="modal" data-bs-target="#deleteModal"><button class="btn chatForm" name="delete" id="delete" type="submit"><i class="bi bi-trash3"></i> Delete</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container container-5">
                ...
                <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog modal-dialog-centered modal-dialog-scrollable">
                        <div class="modal-content">
                            <div class="modal-header">
                                <div class="modal-title" id="exampleModalLabel">Anda yakin ingin menghapus data inir?</div>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                Data yang dihapus tidak akan ditampilkan lagi dan akan terhapus permanen
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                <a class="btn btn-primary" href="delete.php?house_id=<?= $result['house_id']; ?>" style="background-color: #20C997;">delete</a>
                            </div>
                        </div>
                    </div>
                </div>
