                                            ...
                                            <div class="col">
                                                <div class="card h-100 round1">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <a href="detail_adminpage.php?house_id=<?= $hd['house_id']; ?>"><button class="btn detailForm" type="button" name="submit">Update<i class="bi bi-chevron-compact-right ms-2"></i></button></a>
                                                    </div>
                                                </div>
                                            </div>
                                        <?php endforeach; ?>
