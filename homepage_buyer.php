...
$house_data = query("SELECT * FROM (((house_data JOIN house_data_status USING(status_id)) JOIN account USING(user_id)) JOIN account_level USING(level_id)) WHERE status_id = 'S002'");
...
<head>
    ...
    <link rel="stylesheet" href="css/homepage_buyer_style.css">
                    ...
                    <div class="col">
                        <div class="card h-100 round1">
                            ...
                            <div class="card-body">
                                ...
                                <a href="details_buyer.php?house_id=<?= $hd['house_id']; ?>"><button class="btn detailForm" type="button" name="submit">Details<i class="bi bi-chevron-compact-right ms-2"></i></button></a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
